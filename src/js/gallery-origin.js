import * as elementsInViewportHandling from "./in-viewport.js"
...
document.addEventListener('scroll', ()=>{
    imagesOfTheGallery.forEach(image =>{
        ...
        if(image === lastImageOfTheGallery){
            elementsInViewportHandling.isTheElementTopOnBottomOfTheViewport(image) && (image.style.opacity = '1')
        }

        elementsInViewportHandling.isTheElementTopOnTopOfTheViewport(image) && (image.style.opacity = '1')
    })
})
